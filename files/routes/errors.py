...
def error_400(e, v):
    if request.headers.get("Authorization"):
        ...
        return render_template("errors/400.html", v=v), 400
...
def error_410(e, v):
    if request.headers.get("Authorization"):
        ...
        return render_template("errors/410.html", v=v), 410
...
def error_418(e, v):
    if request.headers.get("Authorization"):
        ...
        return render_template("errors/418.html", v=v), 418
...
def error_500(e, v):
    ...
    if request.headers.get("Authorization"):
        ...
        return render_template("errors/500.html", v=v), 500
...
def error_502(e, v):
    if request.headers.get("Authorization"):
        ...
        return render_template("errors/502.html", v=v), 502
...
def error_503(e, v):
    if request.headers.get("Authorization"):
        ...
        return render_template("errors/503.html", v=v), 503
